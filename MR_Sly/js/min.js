...
let c13 = document.getElementById('card13');
let c14 = document.getElementById('card14');
let c15 = document.getElementById('card15');
let c16 = document.getElementById('card16');
...
let hh7 = document.getElementById('hcn7');
let hh8 = document.getElementById('hcn8');
let hh9 = document.getElementById('hcn9');
let hh10 = document.getElementById('hcn10');
let hh11 = document.getElementById('hcn11');
let hh12 = document.getElementById('hcn12');
let hh13 = document.getElementById('hcn13');
let hh14 = document.getElementById('hcn14');
let hh15 = document.getElementById('hcn15');
let hh16 = document.getElementById('hcn16');
...
function cd7(){
    content.classList.toggle('factive')
    conheader.textContent = hh7.textContent+' Airtel Tigo'
    content.focus()
}
function cd8(){
    content.classList.toggle('factive')
    conheader.textContent = hh8.textContent+' Airtel Tigo'
    content.focus()
}
function cd9(){
    content.classList.toggle('factive')
    conheader.textContent = hh9.textContent+' Airtel Tigo'
    content.focus()
}
function cd10(){
    content.classList.toggle('factive')
    conheader.textContent = hh10.textContent+' Airtel Tigo'
    content.focus()
}
function cd11(){
    content.classList.toggle('factive')
    conheader.textContent = hh11.textContent+' Airtel Tigo'
    content.focus()
}
function cd12(){
    content.classList.toggle('factive')
    conheader.textContent = hh12.textContent+' Airtel Tigo'
    content.focus()
}
function cd13(){
    content.classList.toggle('factive')
    conheader.textContent = hh13.textContent+' Airtel Tigo'
    content.focus()
}
function cd14(){
    content.classList.toggle('factive')
    conheader.textContent = hh14.textContent+' Airtel Tigo'
    content.focus()
}
function cd15(){
    content.classList.toggle('factive')
    conheader.textContent = hh15.textContent+' Airtel Tigo'
    content.focus()
}
function cd16(){
    content.classList.toggle('factive')
    conheader.textContent = hh16.textContent+' Airtel Tigo'
    content.focus()
}
function cls(){
    content.classList.toggle('factive')
